...
#define AP_SSID     "Makeistan"
#define AP_PASSWORD "arduinonight"  


#define EIOTCLOUD_USERNAME "abdnafees"
#define EIOTCLOUD_PASSWORD "warlord123"
...
{  
  ...
  digitalWrite(buttonPin, !switchState); 
#ifndef DEBUG
